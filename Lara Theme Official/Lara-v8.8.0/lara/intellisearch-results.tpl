<div class="intellisearchresults" id="intelligentSearchResults">
    ...
    <div class="search-footer">
        ...
        <span class="realtime"><input type="checkbox" id="intelliSearchRealtime" data-size="mini" data-label-text="{lang key="search.autoSearchOnType"}" data-on-color="info" data-url="{routePath('admin-search-intellisearch-settings-autosearch')}"{if isset($intelligentSearch.autoSearchEnabled) && $intelligentSearch.autoSearchEnabled} checked{/if}></span>
